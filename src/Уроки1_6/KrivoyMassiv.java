...
public class KrivoyMassiv {
    public static void main(String[] args) {
        //regionДвумерные массивы
//        int[][] dich = new int[5][];
//        dich[1] = new int[2];
//        dich[0] = new int[3];
//        dich[2] = new int[4];
...
//        }
        //endregionЕкуу
        //regionВычисление длин массивов
...
//        System.arraycopy(youngPussy, 2,squarePussy[3],1,2 );
        //endregionВычисление длин массивов
        //regionВычисление времени отработки программ
...
//endregionВычисление времени отработки программ
    }
}
